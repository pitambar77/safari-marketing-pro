    ...
    <div className="smp-home-page">
          ...
          <div className="row add_hero">
            <div className="col-md-6">
              <div className="add-hero-ban-cont">
                ...
                <h1>
                  ROI-Driven Digital Marketing for High-Performing{" "}
                  <span>Safari Brands</span>
                </h1>
                <p>
                  We build high-performing websites and marketing systems that
                  make it easy for travelers to find you, trust you, and contact
                  you. By combining strategy, design, content, and ongoing
                  optimization, we turn your online presence into a reliable
                  source of direct inquiries and bookings.
                </p>
      ...
      <div className="home-page-video">
        <div className="container">
          <div className="smp-video-content">
            <p>
              The result is simple. Our digital marketing solutions boost your
              visibility, attract qualified leads, and create sustainable
            </p>
            <h3>growth for your safari brand.</h3>
          </div>
          ...
          <div className="row main-tustaw">
            <div className="col-md-2">
              <div className="main-tustaward-card">
                <img
                  src="https://www.heroesofdigital.com/wp-content/uploads/2025/03/PremierBadge.png"
                  alt=""
                  className="w-100"
                />
              </div>
            ...
            <div className="col-md-2">
              <div className="main-tustaward-card">
                <img
                  src="https://www.heroesofdigital.com/wp-content/uploads/2025/02/Facebook-Meta-Background-PNG.png"
                  alt=""
                  className="w-100"
                />
              </div>
            ...
            <div className="col-md-2">
              <div className="main-tustaward-card">
                <img
                  src="https://www.heroesofdigital.com/wp-content/uploads/2025/02/statista.jpg.webp"
                  alt=""
                  className="w-100"
                />
              </div>
            ...
            <div className="col-md-2">
              <div className="main-tustaward-card">
                <img
                  src="https://www.heroesofdigital.com/wp-content/uploads/2025/02/the-straits-times-statista.jpg.webp"
                  alt=""
                  className="w-100"
                />
              </div>
            ...
            <div className="col-md-2">
              <div className="main-tustaward-card">
                <img
                  src="https://www.heroesofdigital.com/wp-content/uploads/2025/02/bea_sea_badge_720x720.png.webp"
                  alt=""
                  className="w-100"
                />
              </div>
            ...
            <div className="col-md-2">
              <div className="main-tustaward-card">
                <img
                  src="https://www.heroesofdigital.com/wp-content/uploads/2025/02/PPA23_winner_badge_400x400_SEA_lead_generation_2x-1.webp"
                  alt=""
                  className="w-100"
                />
              </div>
      ...
      <div className="smp-arards-box">
        <div className="container">
          <div className="comon-heading-box">
            <h2>
              Excellence Defined:{" "}
              <span>Google's Highest Recognised Premier Partner</span> for
            ...
            <div className="row awrd-main-mab">
              <div className="col-md-7">
                <div className="smp-arwsa-card">
                  <img
                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/02/winner_sea_breakthrough-excellence-award_yellow_1080x1080.jpg.webp"
                    alt=""
                    className="w-100"
                  />
                </div>
              ...
              <div className="col-md-5">
                <div className="smp-arwsa-card">
                  <img
                    src="https://images.ctfassets.net/02qb7dc7cg75/3vBbBrzecNWyUJmZ4BFKof/53515a981e8bdd4c4ee69216e76176d3/PMAfinalists_effect_portrait.png"
                    alt=""
                    className="w-100"
                  />
                </div>
              ...
              <div className="col-md-7">
                <div className="smp-arwsa-card">
                  <img
                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/03/hero-award-1536x803.webp"
                    alt=""
                    className="w-100"
                  />
                </div>
              ...
              <div className="col-md-5">
                <div className="smp-arwsa-card">
                  <img
                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/03/HOD-x-Google-46-1536x1152.jpg.webp"
                    alt=""
                    className="w-100"
                  />
                </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="digita-smp-pico">
                              <img
                                src="https://www.heroesofdigital.com/wp-content/uploads/2025/03/heroes01.jpg.webp"
                                alt=""
                                className="w-100"
                              />
                            </div>
                      ...
                      <div className="digita-smp-rpara">
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="digita-smp-pico">
                              <img
                                src="https://www.heroesofdigital.com/wp-content/uploads/2025/03/HOD-x-Google-31.jpg.webp"
                                alt=""
                                className="w-100"
                              />
                            </div>
                      ...
                      <div className="digita-smp-rpara">
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="digita-smp-pico">
                              <img
                                src="https://www.heroesofdigital.com/wp-content/uploads/2025/03/HOD-x-Google-25.jpg.webp"
                                alt=""
                                className="w-100"
                              />
                            </div>
      ...
      <div className="digita-revenue-bxo">
        <div className="container">
          <div className="comon-heading-box">
            <h2>
              Stop Measuring Clicks <br />
              <span>Start Measuring Bookings</span>
            </h2>
            <p>
              Getting traffic is nice, but traffic does not run a safari
              business. Bookings do.
            </p>
          </div>
      ...
      <div className="smp-leads-revenuse-box">
        <div className="container">
          <div className="comon-heading-box white-main-hed">
            <h2>
              Our 360° Marketing Ecosystem
              {/* <span>High Quality Leads & Revenue</span> */}
            </h2>
            <p>
              Struggling to turn safari traffic into real bookings? Our 360
              marketing ecosystem connects your website, organic visibility,
              paid acquisition, sales process, and on-ground operations into one
              system that generates qualified safari inquiries and bookings.
            </p>
          </div>
          <FunnelSection />
        </div>
            ...
            <div className="row work-with-child">
              <div className="col-md-4">
                <div className="why-you-work-card">
                  ...
                  <h3>Deep Safari Industry Expertise</h3>
                  <p>
                    We work exclusively with safari and tour operators, so we
                    understand your challenges, from seasonality to customer
                    booking behavior. Our strategies are tailored specifically
                    for the African safari market.
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="why-you-work-card">
                  ...
                  <h3>Tailored Safari Marketing Solutions</h3>
                  <p>
                    Every plan starts with research into your business,
                    audience, and competitors. This ensures we reach the right
                    customers, not just any traffic.
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="why-you-work-card">
                  ...
                  <p>
                    SMP has worked with over 500 clients in the tour and travel
                    industry, including well-known safari brands. Our strategies
                    in websites, SEO, content, and marketing campaigns have
                    helped operators increase visibility, inquiries, and
                    bookings. We also have client success stories that highlight
                    the real results we deliver.
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="why-you-work-card">
                  ...
                  <h3>Safari Websites That Convert</h3>
                  <p>
                    Your website is often the first impression travellers get.
                    We build high-converting safari websites that feel
                    authentic, professional, and aligned with what high-intent
              ...
              <div className="col-md-4">
                <div className="why-you-work-card">
                  ...
                  <h3>360° Safari Marketing Ecosystem</h3>
                  <p>
                    From organic SEO and content that ranks to targeted ad
                    campaigns, SMP builds comprehensive plans that boost your
                    online presence and drive direct bookings.
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="why-you-work-card">
                  ...
                  <p>
                    We value long-term partnerships. You get dedicated project
                    management, regular reporting, and clear communication, not
      ...
      <div className="meet-smp-techno">
        <div className="container">
          <div className="comon-heading-box white-main-hed">
            <h2>
              Our technology for <span>data-driven, revenue-generating</span>{" "}
              digital marketing
            </h2>
          </div>
            ...
            <div className="row">
              <div className="col-md-3">
                <div className="digital-counter-smp">
                  <h3>100%+</h3>
                  <p>
                    Data points analysed to connect campaigns directly to
                    revenue
                  </p>
                </div>
              </div>
      ...
      <div className="clients-satisfied-smp">
        <div className="container">
          <div className="comon-heading-box">
            <h2>
              Generating high quality leads and revenue for{" "}
              <span>800+ satisfied clients</span> since 2010
            </h2>
            <p>
              With With $130M+ in trackable revenue generated for our clients
              since 2010, Heroes of Digital is more than a digital marketing
              agency. We’re your growth partner—equipped with the strategies,
              industry expertise, and technology to turn marketing into a profit
                          ...
                          <Tab.Pane eventKey="first">
                            <div className="clients-satisfied-brands">
                              <ul>
                                <li>
                                  <img
                                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/03/Capital-Heart-Centre-CHC.webp"
                                    alt=""
                                    className="w-100"
                                  />
                                </li>
                                <li>
                                  <img
                                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/03/Atlas-Podiatry.webp"
                                    alt=""
                                    className="w-100"
                                  />
                                </li>
                                <li>
                                  <img
                                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/06/International-Centre-for-Cardiothoracic-Surgery-ICTS.png"
                                    alt=""
                                    className="w-100"
                                  />
                                </li>
                                <li>
                                  <img
                                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/03/Oxford-Ortho.webp"
                                    alt=""
                                    className="w-100"
                                  />
                                </li>
                                <li>
                                  <img
                                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/06/ENT-Surgeons-Medical-Centre-2.jpg.webp"
                                    alt=""
                                    className="w-100"
                                  />
                                </li>
                                <li>
                                  <img
                                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/06/chongheelim.png.webp"
                                    alt=""
                                    className="w-100"
                                  />
                                </li>
                                <li>
                                  <img
                                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/06/Henry-Chan-Ortho.png"
                                    alt=""
                                    className="w-100"
                                  />
                                </li>
                                <li>
                                  <img
                                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/04/Skin-lab-logo.png.webp"
                                    alt=""
                                    className="w-100"
                                  />
                                </li>
        ...
        <div className="container">
          <div className="comon-heading-box white-main-hed">
            <h2>
              ...
              <span>Meta Ads Agency</span> Services
            </h2>
          </div>
      ...
      <div className="add_faqs-sec smphome-faqs">
        <div className="container">
          <div className="comon-heading-box">
            <h2>
              What makes us <span>your growth partner,</span> and not just
              another digital marketing vendor?
            </h2>
            <p>
              The difference is in the approach we take – an effective
              methodology that has been tried and tested.
            </p>
          </div>
