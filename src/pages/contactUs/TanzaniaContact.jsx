    ...
    <div className="contact-us-page">
      <div className="tanzania-contact">
        <div className="contact-wrapper">
          <h1>We're the agency you don't want working for your competitors.</h1>

          <p className="sub-text">
            Contact us today and find out how we can help you grow your
            business.
          </p>
                ...
                <div className="addres-details-addres">
                  ...
                  <div className="details-addres-box">
                    <div className="details-addres-ncxc">
                      <h4>Address</h4>
                      <p>
                        Plot No- 26.1996/2231, Arundhati Resident, B2,
                        Patrapada, 751019
                      </p>
                    </div>
...
export default TanzaniaContact;
