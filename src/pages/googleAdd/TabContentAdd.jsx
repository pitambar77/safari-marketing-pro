            ...
            <div className="row conte_details">
              <div className="col-md-6">
                <div className="conte_details-para">
                  ...
                  <p>
                    Your ads automatically adapt to fit placements across
                    Google’s network, helping your brand appear professional.
                  </p>
        ...
        {activeTab === "tabtwo" && (
          <div className="tab_content">
            <div className="row conte_details">
              <div className="col-md-6">
                <div className="conte_details-para">
                  <h3>Multi-Platform Ad Management</h3>
                  <p>
                    campaigns are managed from a single dashboard, ensuring
                    better consistency, performance, and reporting.
                  </p>
                  <p>
                    The result is not just traffic, but qualified inquiries from
                    clients who are ready to move from planning to booking.
                  </p>
                  <div className="datata_btn">
                    <Button text="Get Proposal" link="./" target="_self" />
                  </div>
            ...
            <div className="row conte_details">
              <div className="col-md-6">
                <div className="conte_details-para">
                  ...
                  <p>
                    We run Google Ads search campaigns targeting high‑value
                    keywords your customers use when they’re ready to buy. Our
                    Google Ads services focus on precise keyword bidding, ad
                    copy testing, and conversion‑driven landing page design to
            ...
            <div className="row conte_details">
              ...
              <div className="col-md-6">
                <div className="conte_details-pico">
                  <img
                    src="https://www.heroesofdigital.com/wp-content/uploads/2025/04/Google-Search-Advertising.webp"
                    alt="Gmail Advertising"
                    title="Gmail Advertising"
                    className="w-100"
                  />
                </div>
              </div>
