                ...
                <div className="row add_hero">
                    <div className="col-md-7">
                        <div className="add-hero-ban-cont">
                            <h3>Google Ads Marketing Agency Singapore</h3>
                            <h1>Make more money from SEM with <span>the most trusted Google Ads agency in Singapore</span></h1>
                ...
                <div className="row google_gark">
                    <div className="col-md-6">
                        <div className="comon-heading-box google_gark_left">
                            <h2>Drive Growth with the Full Power of <span>Google Ads Marketing</span></h2>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="google_gark_para">
                            <p>Google Ads isn’t just about getting seen — it’s about getting seen by the right people, at the right time, with the right message. As a leading Google Ads agency in Singapore, we use advanced targeting to place your brand in front of high-intent prospects the moment they’re ready to act — whether they’re searching on Google, watching YouTube, or browsing sites across the Google Display Network (GDN).</p>
                            <p>Every Google Ads campaign is engineered to turn attention into action through precise targeting, persuasive ad copy, and continuous optimisation — helping you outpace competitors, capture market share, and turn ad spend into measurable, scalable revenue growth.</p>
                            <h3>Let us match the right campaign type to your buyers</h3>
                            <p>Google Ads offers multiple campaign types to reach customers across the web. At Heroes of Digital, we tailor the right mix to your business goals, ensuring you connect with the right audience at every stage of their buying journey.</p>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <div className="google-tab-sec">
            <div className="container">
                ...
                <div className="conversions-box">
                    ...
                    <p><strong>Half a million conversions don&rsquo;t happen by accident.</strong>&nbsp;They&rsquo;re the result of years of refining ad strategies, testing every variable, and applying insights across industries. Each conversion represents a customer who took action &mdash; booking a service, making a purchase, or signing up for more. By focusing on what moves the needle for each business, we&rsquo;ve built a system that keeps delivering.&nbsp;<strong>And we&rsquo;re ready to do it for you.</strong></p>
                    <Button  text="Increase My Conversion Today!" link="./"  target="_self" />
                </div>
            </div>
         </div>
