    ...
    <div className="smp-review-page">
          ...
          <div className="row add_hero">
            <div className="col-md-7">
              <div className="add-hero-ban-cont">
                ...
                <p>
                  {" "}
                  Read real stories about how we’ve helped them connect with
                  travelers, boost engagement, and increase revenue — one
                  campaign, one website, and one experience at a time.
                </p>
      ...
      <div className="add_agency-sec">
        <div className="container">
          <div className="comon-heading-box">
            <h2>
              Top SMEs and MNCs in Singapore choose us as their{" "}
              <span>Google Ads agency in Singapore</span>
            </h2>
          </div>
      ...
      <div className="costomer-review-rating">
        <div className="container">
          ...
          <div className="comon-heading-box">
            <h2>
              Hear from 1,100+ Happy <span>SMP customers</span>
            </h2>
            <p>
              As an online SEO agency, performance isn’t a promise — it’s our
              standard. Our SEO services combine strategic thinking, data-backed
